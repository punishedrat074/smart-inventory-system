...
7. **Clear comments where appropriate** — Explain *why*, not *what*; never comment obvious code
...
*This plan is a living document. Feature scope is defined in [FEATURES.md](./FEATURES.md). Task breakdown is in [TASKS.md](./TASKS.md).*
